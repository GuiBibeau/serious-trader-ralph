...
const BUILTIN_RUNTIME_VENUE_CAPABILITIES = [
  ...
  },
  {
    ...
    onboardingState: "integrated",
    notes:
      "Bounded DFlow prediction-market substrate for shadow and paper. Official DFlow docs expose market discovery, market-by-mint resolution, position tracking, settlement, and redemption flows, while production prediction-market apps still require Proof or Kalshi compliance checks. Live stays disabled until a later issue lands Proof-aware account gating, settlement reconciliation fixtures, and tiny-notional canaries.",
  },
  {
    schemaVersion: "v1",
    venueKey: "drift_bet",
