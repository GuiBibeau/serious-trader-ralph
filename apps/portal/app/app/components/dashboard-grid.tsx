...
const DEFAULT_DASHBOARD_LAYOUTS: Record<LayoutBreakpoint, Layout[]> = {
  lg: [
    { i: "market", x: 0, y: 0, w: 9, h: 4 },
    { i: "agents", x: 9, y: 0, w: 3, h: 4 },
  ...
  md: [
    ...
    { i: "agents", x: 0, y: 4, w: 4, h: 4 },
    { i: "wallet", x: 4, y: 4, w: 6, h: 3 },
    { i: "macro_radar", x: 0, y: 8, w: 5, h: 3 },
    { i: "macro_fred", x: 5, y: 8, w: 5, h: 3 },
    { i: "macro_etf", x: 0, y: 11, w: 5, h: 3 },
    { i: "macro_stablecoin", x: 5, y: 11, w: 5, h: 3 },
    { i: "macro_oil", x: 0, y: 14, w: 10, h: 3 },
  ],
  sm: [
    { i: "market", x: 0, y: 0, w: 6, h: 4 },
    { i: "agents", x: 0, y: 4, w: 6, h: 4 },
    { i: "wallet", x: 0, y: 8, w: 6, h: 2 },
    { i: "macro_radar", x: 0, y: 10, w: 6, h: 3 },
    { i: "macro_fred", x: 0, y: 13, w: 6, h: 3 },
    { i: "macro_etf", x: 0, y: 16, w: 6, h: 3 },
    { i: "macro_stablecoin", x: 0, y: 19, w: 6, h: 3 },
    { i: "macro_oil", x: 0, y: 22, w: 6, h: 3 },
  ],
};
...
export function DashboardGrid({
  ...
  // We don't need manual mounted check since useContainerWidth provides it,
  // but we can keep a check if we want or just use 'mounted' from hook.
