...
export const RESERVED_SLUGS = new Set([
  "terminal", "login", "news", "app", "api", "og", "settings", "checkout",
  "onboarding", "tokensxyz", "deepseek", "jupiter", "yahoo", "gdelt",
  "notify-discord", "token", "equities", "pre-ipo", "crypto", "assets",
  "share", "sitemap.xml", "robots.txt", "llms.txt", "favicon.ico",
]);
