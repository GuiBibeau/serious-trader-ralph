...
const FALLBACK = [
  "NVDA", "ONDO", "WTIOIL", "TAO", "SUI", "TON", "FET", "ETH", "SOL", "ZEC",
  "TRX", "ADA", "JUP", "BNB", "GOLD", "AAVE", "MEGA", "DOGE", "SKR", "COPPER",
  "XRP", "MET", "JTO", "VVV", "SILVER", "BTC", "CHIP", "AAPL", "RENDER",
  "WLD", "VIRTUAL", "HYPE", "XLM", "XPL", "FARTCOIN", "NEAR", "MORPHO",
  "ENA", "MON", "PUMP", "LIT",
];
